...
public class HexCalc {
	...
	public static boolean hexGreater(String hexdecnum1, String hexdecnum2) {
		...
		// int comparisonResult = hexdecnum1.compareTo(hexdecnum2);
	...
	public static boolean hexSmaller(String hexdecnum1, String hexdecnum2) {
	...
	public static boolean hexEqual(String hexdecnum1, String hexdecnum2) {
	...
	public static void main(String args[]) {
		...
		do {
			...
			case 5:
				...
				break;
			case 6:
				boolean c = hexSmaller(hexdecnum1, hexdecnum2);
				System.out.print(c + "\n");
				break;
			case 7:
				boolean d = hexEqual(hexdecnum1, hexdecnum2);
				System.out.print(d + "\n");
				break;
			case 8:
				System.exit(0);
