		...
		<div class="row">
			<div class="col-md-3 space imageshape">
				<div class="userdetails text-center">
					<div class="img">
							  <img src="/image/${ProfileImformation.profile}" class="rounded img-fluid" alt="${ProfileImformation.fullname}"> 
					</div>
					<div class="name">
					 <a href="/friendProfile/${ProfileImformation.id}"><h5>${ProfileImformation.fullname}</h5></a>
					</div>
				</div>
			</div>	
			...
			<div class="col-md-8 space details">
				<div class="card">
					...
					<div class="container">
						...
						<p>+91 ${ProfileImformation.contact}</p>
					</div>
					<hr>
					<div class="container">
						<h4>
