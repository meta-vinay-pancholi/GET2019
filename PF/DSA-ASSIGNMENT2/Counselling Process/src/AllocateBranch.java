...
public class AllocateBranch {
	...
	public void studentAllocation() throws BiffException, IOException {
		...
		for (int i = 0; i < Obj2.student.size(); i++) {
			...
			ArrayList<String> perticularStudentBranch = new ArrayList<String>();
			perticularStudentBranch = Obj2.student.get(i).preference;
			for (int j = 0; j < perticularStudentBranch.size(); j++) {
				String studentBranch = perticularStudentBranch.get(j);
