...
<%if(session.getAttribute("user")==null) {
	...
	<form align="center" action="GetVehicleNumber" method="post">
		...
		<button type="submit" name="submit" value="submit">Get Vehicle</button>
	</form>
		...
		<%
			...
			if(request.getAttribute("vehicleDetails")!=null) {
				...
				for(int i=0; i<vechileDetails.size();i++) {
					out.print("Vehicle number = <a href='BookGatePass?vtype="+vechileDetails.get(i).getType()+"&id="+vechileDetails.get(i).getId()+"' >"+vechileDetails.get(i).getVnumber()+"</a><br><br>");
				}
			}	
