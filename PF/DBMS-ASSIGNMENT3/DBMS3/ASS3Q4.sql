...
INSERT INTO city_state(zipcode_id,city,state) VALUES(1,'RAWATBHATA','RAJASTHAN'),(2,'MUMBAI','MAHARASHTRA'),(3,'JAIPUR','RAJASTHAN'),(4,'DELHI','DELHI'),(5,'Panji','GOA'),(6,'Ahembdabad','Gujrat'),(7,'patna','Bihar'),(8,'Kishangarh','Rajasthan'),(9,'Hyderabad','Telangana');
