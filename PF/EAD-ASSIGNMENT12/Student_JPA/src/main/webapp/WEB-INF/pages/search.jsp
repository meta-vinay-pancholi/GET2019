	...
	<div class="container ">
		...
		<form:form modelAttribute="SearchCommand">
			...
			<div class="form-group">
				...
				<form:input path="firstName" cssClass="form-control" id="firstName" placeholder="Enter Student first Name" />
 	...
 	<c:if test="${not empty studentData}">
		<div class="table-responsive">
			<table class="table table-bordered">
				...
				<tbody>
					<c:forEach var="student" items="${studentData}" varStatus="loopcounter">
    					<tr>
